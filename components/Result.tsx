    ...
    <section className="w-full p-12 rounded-[15px] bg-ctp-crust mt-6 flex gap-[37px]">
      ...
      <div className="w-full">
        <div className="flex justify-between items-center px-[6px]">
          <h2 className="text-[26px] font-bold">The Octocat</h2>
          <p className="text-[15px]">Joined 25 Jan 2011</p>
        </div>
        <span className="text-base text-ctp-blue">@octocat</span>
        ...
        <div className="py-[15px] px-8 rounded-[10px] w-full bg-ctp-base mt-8 flex items-center justify-between">
          <div className="">
            ...
            <span className="font-bold text-[22px]">8</span>
          </div>
          <div className="">
            <h6 className="text-[13px]">Followers</h6>
            <span className="font-bold text-[22px]">3938</span>
          </div>
          <div className="">
            <h6 className="text-[13px]">Following</h6>
            <span className="font-bold text-[22px]">9</span>
          </div>
        </div>
        <div className="w-full my-[37px] grid grid-cols-2 text-[15px]">
          <div className="w-full flex flex-col gap-5">
            ...
            <div className="w-full flex items-center gap-5">
              ...
              <Link href="https://github.blog" className="hover:underline">
                https://github.blog
              </Link>
            </div>
          </div>
